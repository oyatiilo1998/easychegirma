...
type UserServiceClient interface {
	Create(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserCreatedResponse, error)
	Get(ctx context.Context, in *UserGetReq, opts ...grpc.CallOption) (*User, error)
...
func (c *userServiceClient) Create(ctx context.Context, in *User, opts ...grpc.CallOption) (*UserCreatedResponse, error) {
...
func (c *userServiceClient) Get(ctx context.Context, in *UserGetReq, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
func (c *userServiceClient) UserExists(ctx context.Context, in *UserExistsRequest, opts ...grpc.CallOption) (*UserExistsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/genproto.UserService/UserExists", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	Create(context.Context, *User) (*UserCreatedResponse, error)
	Get(context.Context, *UserGetReq) (*User, error)
...
func (UnimplementedUserServiceServer) Create(context.Context, *User) (*UserCreatedResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedUserServiceServer) Get(context.Context, *UserGetReq) (*User, error) {
...
func _UserService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).Get(ctx, req.(*UserGetReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserService_UserExists_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/genproto.UserService/UserExists",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
