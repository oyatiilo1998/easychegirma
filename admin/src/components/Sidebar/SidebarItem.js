...
import { experimentalStyled, ListItem, alpha, ListItemIcon, ListItemText, Collapse } from '@mui/material';
import { Box } from '@mui/system';
// material

// ----------------------------------------------------------------------

export const ListItemStyle = experimentalStyled(ListItem)(({ theme }) => ({
...
const SubIconStyle = experimentalStyled('span')(({ theme }) => ({
  width: 22,
  height: 22,
  display: 'flex',
  alignItems: 'center',
